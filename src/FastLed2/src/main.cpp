...
void setup()
{
  ...
  Animator.addAnimation(new BlinkAnimation(0));
  Animator.addAnimation(new BlinkAnimation(1));
  Animator.addAnimation(new PulseAnimation(0));
  Animator.addAnimation(new PulseAnimation(1));
