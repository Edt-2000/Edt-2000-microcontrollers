...
//#define MAT_PIN 5           /* Data for matrix on D3 on ESP8266 */
//#else
#define MAT_PIN 5           /* Data for matrix on pin 6 for Arduino/other */
#endif
...
#define BRIGHT 35           /* brightness; min 0 - 255 max -- high brightness requires a hefty power supply! Start low! */
...
//#define  MULTIPANEL          /* define to enable multi-panel support */
#define PANELS_W    10       /* Number of panels wide */
#define PANELS_H    1       /* Number of panels tall */
//#define  PANEL_TOP           /* define if first panel is upper-left */
