...
// Animators::FastLedAnimator::FastLEDColorScheduler()
// {
// }

// Animators::FastLedAnimator::FastLEDColorScheduler(CRGB *leds, uint8_t nrOfLeds)
// {
// }

// void Animators::FastLedAnimator::solid(uint8_t start, uint8_t end, uint8_t h, uint8_t s, uint8_t v)
// {
...
// void Animators::FastLedAnimator::fade(uint8_t start, uint8_t end, uint8_t duration, FadeMode mode)
// {
// 	commandFade = Command();
...
// void Animators::FastLedAnimator::rainbow(uint8_t start, uint8_t end, uint8_t h, uint8_t dh)
// {
// 	commandColor = Command();
...
// void Animators::FastLedAnimator::rainbow(uint8_t start, uint8_t center, uint8_t end, uint8_t h, uint8_t dh, uint8_t intensity)
// {
// 	commandColor = Command();
// 	commandColor.type = Type::rainbow;
// 	commandColor.start = start;
...
// void Animators::FastLedAnimator::twinkle(uint8_t start, uint8_t end, uint8_t h, uint8_t s, uint8_t v, uint8_t intensity, bool blackOut)
// {
...
// void Animators::FastLedAnimator::strobo(uint8_t h, uint8_t intensity)
// {
// 	commandColor = Command();
...
// void Animators::FastLedAnimator::chase(uint8_t h, uint8_t speed, uint8_t style)
// {
// 	commandColor = Command();
...
// void Animators::FastLedAnimator::bash(uint8_t h, uint8_t intensity)
// {
// 	commandColor = Command();
...
// Command Animators::FastLedAnimator::getCommandColor()
// {
// 	return commandColor;
// }

// Command Animators::FastLedAnimator::getCommandTwinkle()
// {
// 	return commandTwinkle;
// }

// Command Animators::FastLedAnimator::getCommandFade()
// {
// 	return commandFade;
// }
