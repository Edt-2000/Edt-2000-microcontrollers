...
namespace Dispedter.Tester
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private readonly SenderManager _senderManager = new SenderManager(detectUsb: true, udpDestinations: new[] { IPAddress.Parse("10.0.0.20"), IPAddress.Parse("10.0.0.21") });
